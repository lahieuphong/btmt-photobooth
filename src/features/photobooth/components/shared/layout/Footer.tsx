        ...
        >
          <div className="flex w-full items-center justify-center px-[4%]">
            <div className="inline-flex flex-col items-center text-white [text-shadow:0_0_2px_rgba(255,255,255,0.35)]">
              <p className="photobooth-footer-title whitespace-nowrap font-serif text-[clamp(20px,3.3vw,39px)] font-medium uppercase leading-[1.04] tracking-[0.04em]">
                Bảo Tàng Mỹ Thuật
              </p>
              <p className="photobooth-footer-subtitle mt-[0.1em] whitespace-nowrap font-serif text-[clamp(16px,2.55vw,31px)] font-medium uppercase leading-[1.04] tracking-[0.04em]">
